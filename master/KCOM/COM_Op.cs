...
namespace KCOM
{
    partial class COM
    {
        public void Update_SerialPortName(SerialPort sp, ComboBox _comboBox_COMNumber)
        {
        ...
        private void Update_SerialBaudrate(SerialPort sp, ComboBox _comboBox_COMBaudrate)
        {   
        ...
        public void Update_SerialParityBit(ComboBox _comboBox_COMCheckBit)
        {   
        ...
        public void Update_SerialDataBit(ComboBox _comboBox_COMDataBit)
        {   
        ...
        public void Update_SerialStopBit(ComboBox _comboBox_COMStopBit)
        {
            ...
            ComboBox _comboBox_COMCheckBit, ComboBox _comboBox_COMDataBit , ComboBox _comboBox_COMStopBit)
        {
            ...
            Update_SerialPortName(serialport, _comboBox_COMNumber);

            _comboBox_COMBaudrate.SelectedIndex = Properties.Settings.Default._baudrate_select_index;
            Update_SerialBaudrate(serialport, _comboBox_COMBaudrate);
        ...
        public int width_comlist = 91;
        public const int BAUDRATE_WITH_SELECT = 320;

        public void comboBox_COMNumber_DropDown(ComboBox _comboBox_COMNumber, SerialPort sp)
        {
        ...
        public void comboBox_COMBaudrate_DropDown(ComboBox _comboBox_COMBaudrate)
        {
            Rebulid_BaudrateList(_comboBox_COMBaudrate);
        }

        public void comboBox_COMBaudrate_SelectedIndexChanged(ComboBox _comboBox_COMBaudrate, SerialPort sp)
        {
